export default {
    ...
    email:'Email :',
    phone:'Phone :',
    driver_account_approve_err:'Your account is not approved yet as a driver.',
    account_not_exsist:'Your account does not exist as a driver.',
    ...
    account_successful_done:'Your account has been successfully created and waiting for approval by the admin, You will be sent an Email/SMS on your approval status. Thank You!',
    ...
    cancel:'Cancel',
    yes:'Yes',
    password_change:'You Password is successfully updated',
    password_not_match:'password does not match',
    ...
    notification_title:'PickMeCab Notification',
    register:'Register',
